...
const Settings = () => {
    ...
    try {
      ...
      switch (apiName) {
        case 'youtube':
          ...
          break;
        case 'spotify':
          // Test Spotify by searching for a common artist
  ...
  const apiConfigurations = [
    ...
    },
    {
      ...
      required: true,
      configured: true, // Assume configured if we got here
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Configure API integrations and system settings</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="text-center">
            ...
            <div className="text-sm font-medium text-gray-900">YouTube Integration</div>
            <div className="text-xs text-gray-500">
          ...
          <div className="text-center">
            ...
            <div className="text-sm font-medium text-gray-900">Processing Engine</div>
                ...
                {api.status && (
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-3 text-sm">
                    <div>
                      ...
                      <span className={`ml-2 font-medium ${getApiStatusColor(api.status)}`}>
                ...
                {!api.configured && (
                  <div className="mt-3 p-3 bg-gray-50 rounded-md">
                    <div className="text-sm text-gray-700">
                      ...
                      {api.key === 'lastfm' && (
                        <ol className="list-decimal list-inside space-y-1 text-xs">
                          <li>Go to <a href="https://www.last.fm/api/account/create" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Last.fm API</a></li>
      ...
      <div className="flex justify-end">
        <button className="flex items-center px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
